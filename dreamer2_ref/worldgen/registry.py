...
_CLASS_FOLDERS: tuple[tuple[str, str, str | None], ...] = (
...
def _validate_and_resolve(registry: Registry) -> None:
    ...
    authored as a pack. Fallback chain dangling references are soft as
    well: the resolvers degrade gracefully when a link is missing.
    """
    errors: list[str] = []
